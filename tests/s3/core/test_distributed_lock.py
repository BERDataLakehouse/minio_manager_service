...
from s3.core.distributed_lock import DistributedLockManager, REDIS_LOCK_TIMEOUT
...
def lock_manager_with_mock_redis(mock_redis_client):
    ...
    with patch("s3.core.distributed_lock.redis") as mock_redis_module:
...
class TestDistributedLockManagerInit:
    ...
    def test_init_with_redis_url(self):
        ...
        with patch("s3.core.distributed_lock.redis") as mock_redis:
